...
import com.dicoding.mystudentdata.adapter.StudentWithCoursesAdapter
import com.dicoding.mystudentdata.adapter.UniversityAndStudentsAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getUniversityAndStudents() {
        val adapter = UniversityAndStudentsAdapter()
        binding.rvStudent.adapter = adapter
        mainViewModel.getAllUniversityAndStudents().observe(this) {
    ...
    private fun getStudentWithCourse() {
        val adapter = StudentWithCoursesAdapter()
        binding.rvStudent.adapter = adapter
