...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        ...
        when {
            TextUtils.isEmpty(length) -> binding.edtLength.error = "Field ini tidak boleh kosong"
            TextUtils.isEmpty(width) -> binding.edtWidth.error = "Field ini tidak boleh kosong"
            TextUtils.isEmpty(height) -> binding.edtHeight.error = "Field ini tidak boleh kosong"
            else -> {
